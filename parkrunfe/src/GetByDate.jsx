...
class GetByDate extends React.Component{
    ...
    render(){
         const path = `http://ec2-13-41-189-141.eu-west-2.compute.amazonaws.com:3000/times?date=`
        return(
            
            <div>
                <label for="date">Select date:</label>
                <input onChange={e=>this.handleChange(e.target.value)} type="date" name="date" id="date"></input>
